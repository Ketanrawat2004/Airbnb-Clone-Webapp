...
const LocationInput = ({ value, onChange, label, placeholder, variant = 'default' }: LocationInputProps) => {
      ...
      <div className="flex-1 relative" ref={suggestionRef}>
        <div className="flex items-center space-x-3 px-4 sm:px-6 py-4 sm:py-5 border-b sm:border-b-0 sm:border-r border-gray-200 min-h-[70px] sm:min-h-[80px]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 text-sm sm:text-base font-medium bg-transparent w-full">
              <HotelAutocomplete
                value={value}
                onChange={onChange}
