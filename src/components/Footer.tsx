...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-orange-900 via-red-900 to-green-900 text-white">
      <div className="indian-container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
          {/* Company Info */}
          <div className="space-y-4">
            <h3 className="text-lg md:text-xl font-bold text-yellow-400">Airbnb Clone+</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/flights" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Search Flights
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/become-host" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Become a Host
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/help/customer-service" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Customer Service
                </Link>
              </li>
              <li>
                <Link to="/help/safety-security" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Safety & Security
                </Link>
              </li>
              <li>
                <Link to="/cancellation-policy" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Cancellation Policy
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/website-analysis" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Website Analysis
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/admin/auth" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Admin Portal
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">support@airbnbcloneplus.com</span>
              </div>
            </div>
            <div className="mt-4">
        ...
        <div className="border-t border-orange-700/50 mt-6 md:mt-8 pt-6">
          <div className="bg-gradient-to-r from-orange-800/50 to-green-800/50 rounded-xl p-4 mb-4 md:mb-6 border border-orange-600/30">
            <div className="flex items-center space-x-4 mb-3">
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-full overflow-hidden bg-gradient-to-r from-orange-500 to-yellow-500 flex-shrink-0 border-2 border-yellow-400">
                <img 
              ...
              <div>
                <h4 className="text-base md:text-lg font-semibold text-yellow-400">Lead Developer</h4>
            ...
            <div className="text-sm text-gray-300 ml-16 md:ml-20">
              ...
              <p className="text-yellow-300 mt-2">Architect of Airbnb Clone+ Experience</p>
            </div>
          </div>
        </div>

        {/* Bottom Section */}
        <div className="border-t border-orange-700/50 pt-4 md:pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
              ...
              <div className="flex flex-wrap justify-center md:justify-end space-x-4 md:space-x-6 text-xs text-gray-400">
                ...
                <Link to="/cookies-policy" className="hover:text-yellow-400 transition-colors">
                  Cookies
                </Link>
                <Link to="/accessibility" className="hover:text-yellow-400 transition-colors">
                  Accessibility
                </Link>
              </div>
            </div>
