...
const FeaturesSection = () => {
  return (
    <section className="py-20 sm:py-24 lg:py-32 bg-gradient-to-br from-pink-900 via-rose-900 to-pink-800 relative overflow-hidden">
      {/* Premium Background Effects */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_50%,rgba(236,72,153,0.12),transparent_50%)]"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(219,39,119,0.12),transparent_50%)]"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_60%_80%,rgba(244,114,182,0.08),transparent_50%)]"></div>
      
      {/* Floating Elements */}
      <div className="absolute top-20 left-20 w-32 h-32 bg-pink-400/8 rounded-full blur-xl animate-float"></div>
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-rose-400/8 rounded-full blur-xl animate-float" style={{ animationDelay: '3s' }}></div>
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16 sm:mb-20 animate-fade-up">
          <div className="inline-block p-2 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full mb-8 shadow-xl">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
            Exceptional Service,
            <span className="block bg-gradient-to-r from-pink-300 via-rose-300 to-pink-400 bg-clip-text text-transparent mt-2">
              Every Single Time
            </span>
          </h2>
          
          <p className="text-pink-100 text-lg sm:text-xl max-w-4xl mx-auto leading-relaxed px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 max-w-6xl mx-auto">
          <div className="group text-center hover-lift animate-fade-up">
            ...
            <p className="text-pink-100 leading-relaxed text-lg px-4">
          ...
          <div className="group text-center hover-lift animate-fade-up" style={{ animationDelay: '0.4s' }}>
            <div className="relative mb-8 mx-auto w-24 h-24">
              <div className="absolute inset-0 bg-gradient-to-br from-pink-400 to-rose-500 rounded-3xl rotate-6 group-hover:rotate-12 transition-transform duration-500 shadow-xl"></div>
              <div className="relative bg-white rounded-3xl w-full h-full flex items-center justify-center shadow-2xl group-hover:shadow-3xl transition-shadow duration-300">
