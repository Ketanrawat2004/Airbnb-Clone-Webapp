...
import { Train, IndianRupee, Coins } from 'lucide-react';
...
const TrainBooking = () => {
  ...
  const handlePayment = async (paymentMethod: 'razorpay' | 'demo') => {
    ...
    if (!passengerName || !age || !gender || !mobile || !email) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-6">Complete Your Train Booking</h1>
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-2">
                  <p><span className="font-semibold">Train:</span> {trainNumber}</p>
