    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="relative bg-gradient-to-r from-rose-600 via-rose-500 to-pink-500 text-white py-24 overflow-hidden shadow-xl">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 
            className="text-5xl md:text-6xl font-bold mb-6 font-playfair tracking-tight drop-shadow-sm animate-fade-up"
            style={{ animationDelay: '0.08s' }}
          >
            Find your <span className="bg-white/10 px-3 rounded-xl text-white shadow-lg backdrop-blur-sm">perfect stay</span>
          </h1>
          <p 
            className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto font-medium animate-fade-up"
          ...
          {/* Hero Search Bar */}
          <div 
            className="max-w-3xl mx-auto bg-white bg-opacity-90 rounded-full shadow-2xl p-3 flex items-center justify-center backdrop-blur-md animate-fade-up"
